...
const EditMarathonHub = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${API_BASE_URL}/marathon-hub/marathon-hub/${hubId}`,
        formData,
        {
      ...
      setError("Error updating Marathon Hub.");
    }
  };
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-6 text-center">Edit Marathon Hub</h2>
      {error && (
        <div
...
export default EditMarathonHub;
