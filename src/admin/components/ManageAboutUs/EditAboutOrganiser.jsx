  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:5000/about/about-organiser/${organiserId}`,
        formData,
        {
      ...
      setError("Error updating About Organiser.");
    }
  };
...
export default EditAboutOrganiser;
