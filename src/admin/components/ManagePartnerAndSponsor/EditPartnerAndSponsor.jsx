  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${API_BASE_URL}/partner-and-sponsor/partner-and-sponsor/${partnerId}`,
        formData,
        {
      ...
      setError("Error updating Partner and Sponsor.");
    }
  };
...
export default EditPartnerAndSponsor;
